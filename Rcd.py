...
def banner():
	clear()
	wel = '# WELCOME TO XLORA BOT IZ'
	wel2 = mark(wel, style='cyan')
	sol().print(wel2)
	au='AUTHOR    :  XLORA BOT IZ\nStatus    :  Premium\nWHATSAPP  : 085769302532\nSisa Lisensi : UNLIMITED\nVERSI : MOD APK ILEGAL\nHARGA LINSESI : Dibawah\n1 Hari : 2 K\n2 Hari : 3 K\n5 Hari : 5 K\n10 Hari : 9 K\n20 Hari : 15 K\n30 Hari : 20 K\n1 Bulan : 21 K\n2 Bulan : 35 K'
	pengembang1=nel(au,style="cyan")
	cetak(nel(pengembang1, title='XLORA BOT IZ'))
...
def menu(my_name,my_id,my_birthday):
	...
	io = '[01] Crack Dari Pertemanan Publik          [ ON  ]\n[02] Crack Dari Pertemanan Publik (Massal) [ ON  ]\n[03] Crack Dari Anggota Grup               [ OFF ]\n[04] Crack Dari Total Pengikut             [ OFF ]\n[05] Crack Dari Reaction Postingan         [ OFF ]\n[06] Crack Dari Komentar Postingan         [ OFF ]\n[07] Crack Dari Saran Teman                [ OFF ]\n[08] Crack Dari Pencarian Nama             [ OFF ]\n[09] Crack Dari Saran Teman                [ OFF ]\n[10] Comming SOON                          [ OFF ]\n[11] Bot Auto Share                        [ OFF ]\n[12] Report Script                         [ ON  ]\n[13] Cek Result Crack                      [ ON  ]\n[14] Cek Opsi Checkpoint                   [ ON  ]\n[99] Harga Lisensi                         [ ON  ]\n[00] Log Out                               [ ON  ]'
	...
	if jh in ['1','01']:
		...
		print(x+'['+h+'•'+x+'] Tunggu Sebentar Ya adek lagi Memuat Adekku Sayang')
		time.sleep(1)
		sw = '# NEXT UPDATE YA NGAB DIBUAT XLORA BOT IZ'
		...
		print(x+'['+h+'•'+x+'] Tunggu Sebentar Ya adek lagi Memuat Adekku Sayang')
		time.sleep(1)
		sw = '# TERIMAKSIH TELAH MELAPORKAN SCRIPT INI SCRIPT TELAH TERKIRIM KE AUTHOR XLORA BOT IZ'
		...
		print(x+'['+h+'•'+x+'] Harga Lisensi ( Upgrade To Premium )')
		time.sleep(3.25)
		print(x+'['+h+'•'+x+'] 1 Hari : 5 K')
		time.sleep(3.25)
		print(x+'['+h+'•'+x+'] 2 Hari : 8 K')
		time.sleep(3.25)
		print(x+'['+h+'•'+x+'] 5 Hari : 10 K')
		time.sleep(3.25)
		print(x+'['+h+'•'+x+'] 1 Minggu : 13 K')
		time.sleep(3.25)
		print(x+'['+h+'•'+x+'] 2 Minggu : 22 K')
		time.sleep(3.25)
		print(x+'['+h+'•'+x+'] 1 Bulan : 32 K')
		time.sleep(3.25)
		print(x+'['+h+'•'+x+'] 2 Bulan : 50 K')
		time.sleep(3.25)
		print(x+'['+h+'•'+x+'] 5 Bulan : 195 K')
		time.sleep(3.25)
		print(x+'['+h+'•'+x+'] 1 Tahun : 500 K')
		time.sleep(3.25)
		print(x+'['+h+'•'+x+'] File + Sc Permanen : 700 K')
		time.sleep(3.25)
		sw = '# INGIN BUY HUBUNGI AUTHOR NYA LANGSUNG XLORA BOT IZ YUK DI BELI SAYANG WA : 085769302532 DAN 085764207225'
...
def dump_publik():
	...
	try:
		...
		teks = '# PERTEMANAN ANDA TIDAK PUBLIK ATAU TOKEN RUSAK PERMANEN CEK TERLEBIH DAHULU'
...
def setting():
	...
	teks = '[01] Crack Dari Akun Tertua (Tidak Di Rekomendasi)\n[02] Crack Dari Akun Termuda (Rekomendasi)\n[03] Acak Urutan ID (Sangat Tinggi Rekomendasi)'
	...
	if hu in ['1','01']:
		...
		sol().print(mark(ric, style='red'))
		exit()
	met = '# PILIH METHOD RETAS AKUN'
	sol().print(mark(met, style='green'))
	ioz = '[01] Method B-Api [ SEGESIT CEPAT ]\n[02] Method Mobile [ LAMBAT ]\n[03] Methode Free Facebook [ SANGAT LAMBAT ]\n[04] Mehod FREE-FACEBOOK [ SANGAT CEPAT ] [ HD PRO ]'
	...
	aplik = input(x+'['+p+'f'+x+'] Tampilkan Aplikasi Terkait dalam isi akun ? (y/t) : ')
	if aplik in ['y','Y']:
		taplikasi.append('ya')
	else:
		taplikasi.append('no')
	osk = input(x+'['+p+'f'+x+'] Tampilkan Hasil Akun Terkena Atau A2F ChekPoint? [ Tidak Di Rekomendasi ] (y/t) : ')
	if osk in ['y','Y']:
		oprek.append('ya')
	else:
		oprek.append('no')
...
def register_device():
	banner()
	wel='# L I S E N S I  I N V A L I D  T O L O N G  M A S U K A N  A T A U  B U Y  S C R I P T  S A M A  X L O R A  B O T  I Z'
...
def lisensi():
	...
	req=requests.get("https://app.cryptolens.io/api/key/activate?token=WyIxNTgzNzM0OSIlF4eDerR2REV2pLVktBTnBoNVc1cVJuYnhWRXN6Z2p0ZGhyMWhyUGoiXQ=={key}"+lisensikuni[0]).json()
	status=req['licenseKey']['key']
	if status ==cek:
		banner()
